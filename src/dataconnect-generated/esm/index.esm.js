...
export const listUserCategoriesRef = (dcOrVars, vars) => {
...
export function listUserCategories(dcOrVars, varsOrOptions, options) {
...
export const createNewTransactionRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function createNewTransaction(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(createNewTransactionRef(dcInstance, inputVars));
}

export const getUserBudgetsRef = (dc) => {
...
export function getUserBudgets(dcOrOptions, options) {
...
export const updateCategoryDescriptionRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function updateCategoryDescription(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
